...
public class LocalDateTimeConverter extends AbstractConverter {
    ...
    private <T> T toDate(final Class<T> type, final long value) {
        ...
        if (type.equals(LocalDateTime.class)) {
            return type.cast(new java.sql.Timestamp(value).toLocalDateTime());
        }
    ...
    private <T> T toDate(final Class<T> type, final String value) {
        ...
        if (type.equals(LocalDateTime.class)) {
            ...
            try {
                return type.cast(LocalDateTime.parse(value, isoLocalDateTime));
    ...
    String toString(final Class<?> type) {
        ...
        } else if (typeName.startsWith(LocalDateTimeConverter.PACKAGE)) {
            typeName = typeName.substring(LocalDateTimeConverter.PACKAGE.length());
        }
        return typeName;
    }
