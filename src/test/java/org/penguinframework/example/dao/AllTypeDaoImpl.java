...
public class AllTypeDaoImpl implements AllTypeDao {
    ...
    @Override
    public List<AllTypeEntity> findAll() {
        return this.jdbcTemplate.query(
                ...
                new BeanPropertyRowMapper<>(AllTypeEntity.class));
    }

    @Override
    public AllTypeEntity findById(long identityType) {
        return this.jdbcTemplate.queryForObject(
                ...
                new BeanPropertyRowMapper<>(AllTypeEntity.class), identityType);
    }

    @Override
    public int updateById(long identityType, AllTypeEntity allType) {
    ...
    @Override
    public int insert(AllTypeEntity allType) {
        return this.jdbcTemplate.update(
