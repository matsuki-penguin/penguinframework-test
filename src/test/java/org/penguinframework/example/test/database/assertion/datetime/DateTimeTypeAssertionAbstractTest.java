...
abstract class DateTimeTypeAssertionAbstractTest {
    @Load
    ...
    abstract class ExcelFileAbstract {
        private Meta getMeta() {
            return Meta.excel().ignoreCols(Collections.singletonMap("datetime_type",
                    DateTimeTypeAssertionAbstractTest.this.dateTimeTypeDao.getIgnoreCols()));
        }

        @Test
        @DisplayName("日時型の列をもつテーブルの初期状態の内容を指定されたExcelファイルの内容で検証されること。")
        void basicTypeTableAssertion() {
            DateTimeTypeAssertionAbstractTest.this.tableAssertion.assertEquals("expected_datetime_type.xlsx", getMeta(),
                    "datetime_type");
        }
        ...
        void basicTypeAdditionTableAssertion() {
            DateTimeTypeAssertionAbstractTest.this.tableAssertion.assertEquals("expected_datetime_type_addition.xlsx", getMeta(),
                    "datetime_type");
        }
        ...
        void basicTypeInsertTableAssertion() {
            ...
            DateTimeTypeAssertionAbstractTest.this.dateTimeTypeDao.insert(entity);
        ...
        void basicTypeUpdateTableAssertion() {
            ...
            entity.setTimeType(LocalTime.of(9, 0));
            entity.setTimestampType(LocalDateTime.of(2022, 2, 3, 9, 0));
            DateTimeTypeAssertionAbstractTest.this.dateTimeTypeDao.updateById(100, entity);

            DateTimeTypeAssertionAbstractTest.this.tableAssertion.assertEquals("expected_datetime_type_update.xlsx", getMeta(),
                    "datetime_type");
        }
        ...
        void basicTypeDeleteTableAssertion() {
            DateTimeTypeAssertionAbstractTest.this.dateTimeTypeDao.deleteById(100);

            DateTimeTypeAssertionAbstractTest.this.tableAssertion.assertEquals("expected_datetime_type_delete.xlsx", getMeta(),
                    "datetime_type");
        }
    }
    ...
    abstract class CsvFileAbstract {
        private Meta getMeta() {
            return Meta.csv().ignoreCols(DateTimeTypeAssertionAbstractTest.this.dateTimeTypeDao.getIgnoreCols());
        }

        @Test
        @DisplayName("日時型の列をもつテーブルの初期状態の内容を指定されたCSVファイルの内容で検証されること。")
        void basicTypeTableAssertion() {
            DateTimeTypeAssertionAbstractTest.this.tableAssertion.assertEquals("expected_datetime_type.csv", getMeta(),
                    "datetime_type");
        }
        ...
        void basicTypeAdditionTableAssertion() {
            DateTimeTypeAssertionAbstractTest.this.tableAssertion.assertEquals("expected_datetime_type_addition.csv", getMeta(),
                    "datetime_type");
        }
        ...
        void basicTypeUpdateTableAssertion() {
            ...
            DateTimeTypeAssertionAbstractTest.this.tableAssertion.assertEquals("expected_datetime_type_update.csv", getMeta(),
                    "datetime_type");
        }
        ...
        void basicTypeDeleteTableAssertion() {
            ...
            DateTimeTypeAssertionAbstractTest.this.tableAssertion.assertEquals("expected_datetime_type_delete.csv", getMeta(),
                    "datetime_type");
        }
    }
}
